...
# UID Binance nhận chuyển nội bộ (Pay/UID). Bỏ trống = không hiển thị lựa chọn này cho khách.
BINANCE_PAY_UID = os.getenv("BINANCE_PAY_UID", "").strip()
# Poller lỗi liên tiếp bấy nhiêu lần thì báo admin 1 lần (chống chết im lặng).

...
if [ "$SCRIPT_DIR" != "$PROJECT_DIR" ]; then
    ...
    FILES_TO_COPY=("bot.py" "jobs.py" "test_binance.py" "ctv_api.py" "hypervin_client.py" "database.py" "binance_client.py" "i18n.py" "sepay_server.py" "config.env.example" "requirements.txt" "ctv-bot.service")
